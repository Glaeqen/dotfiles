...
run_once({ "urxvtd", "setxkbmap pl", "xset -b", "unclutter -root", "telegram-desktop" }) -- entries must be separated by commas
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "Print", function() os.execute("clipboard clipboard-window") end,
      {description = "screenshot window", group = "hotkeys"}),

    awful.key({ }, "Print", function() os.execute("clipboard clipboard-screen") end,
      {description = "screenshot screen", group = "hotkeys"}),


    awful.key({ "Control", "Shift" }, "Print", function() os.execute("clipboard clipboard-region") end,
    ...
    -- By direction layout manipulation
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn.with_shell(terminal .. " || alacritty || xterm") end,
