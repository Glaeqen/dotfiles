...
before packages are loaded."
  ...
  (setq browse-url-browser-function 'browse-url-chromium) ;; Set opening links in Chromium (instead of Firefox)
  (global-evil-mc-mode)
  )
